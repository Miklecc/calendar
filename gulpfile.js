...
gulp.task('sass-less', function () {
  ...
  var scssStream = gulp.src('client/assets/scss/app.scss')
    .pipe($.sass({
  ...
  var lessStream = gulp.src('client/assets/scss/app.less')
    .pipe($.less({
      includePaths: paths.sass,
      outputStyle: (isProduction ? 'compressed' : 'nested'),
      errLogToConsole: true
...
gulp.task('build', function(cb) {
  sequence('clean', ['copy', 'copy:foundation', 'sass-less', 'uglify'], 'copy:templates', cb);
});
